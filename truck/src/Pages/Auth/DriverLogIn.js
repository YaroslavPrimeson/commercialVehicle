...
import {checkProblem, userClientLogIn, userDriverLogIn} from "../../Helper";
...
const DriverRegistration = (props) => {
    const [forms, setForms] = useState(userDriverLogIn)
    ...
    return (
        <div>
            <div className={"AuthContainerInputForm"}>
                <InputForm sendResult={sendResult} model={userDriverLogIn} problem={problem}/>
            </div>
